package com.example.a20273003_last_project;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu01Button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("titleMsg", "INFO 화면");
        ...
        menu02Button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("titleMsg", "ALL 화면");
        ...
        menu03Button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("titleMsg", "HELP 화면");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (intent != null) {
            if (requestCode == REQUEST_CODE_CUSTOMER) {
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "INFO 응답, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "ALL 응답, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "HELP 응답, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        }
